        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-user-secret fa-fw"></i> Input Data Dosen</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
						...
						<input type="number" class="form-control" placeholder="Nip" name="Nip" id="Nip" autocomplete="off" autofocus required>
					</div>
					<div class="form-group">
						<label for="Nama_Dosen">Nama</label>
						<input class="form-control" placeholder="Nama Dosen" name="Nama_Dosen" id="Nama_Dosen" autocomplete="off" required>
					</div>
					<button type="submit" class="btn btn-primary" name="input_dosen">Input Dosen</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->
