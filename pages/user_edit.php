        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-user fa-fw"></i>Edit Data User</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
					...
					<div class="form-group">
						...
						<input class="form-control" placeholder="Nama" name="nama" id="nama" value="<?php echo $row["nama"]; ?>" autocomplete="off" required>
					</div>
					<div class="form-group">
