        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-university fa-fw"></i> Data Perkuliahan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="perkuliahan_input.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Input Perkuliahan</button></a>
                                </div>
                                <!-- /.panel-heading -->
