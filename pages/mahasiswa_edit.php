        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-graduation-cap fa-fw"></i> Edit Data Mahasiswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Nim" name="Nim" id="Nim" autocomplete="off" value="<?php echo $mahasiswa["Nim"] ?>" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="Nama_Mhs">Nama</label>
                        <input class="form-control" placeholder="Nama Mahasiswa" name="Nama_Mhs" id="Nama_Mhs" autocomplete="off" value="<?php echo $mahasiswa["Nama_Mhs"] ?>" autofocus required>
                    </div>
                    <div class="form-group">
                        <label for="Tgl_Lahir">Tanggal Lahir</label>
                        <input class="form-control" placeholder="Tanggal Lahir" name="Tgl_Lahir" id="Tgl_Lahir" type="date" autocomplete="off" value="<?php echo $mahasiswa["Tgl_Lahir"] ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea class="form-control" rows="3" placeholder="Alamat" name="Alamat" id="Alamat" required><?php echo $mahasiswa["Alamat"] ?></textarea>
                    </div> 
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="edit_mahasiswa">Edit Mahasiswa</button>
                    </form>
                </div>
        </div>
        <!-- /#wrapper -->
