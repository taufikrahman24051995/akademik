...
if( isset($_POST["user_ganti_password"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if( UserGantiPassword($_POST) > 0) {
        echo "
            <script>
        ...
        echo "
            <script>
                alert('Password user gagal diganti');
                document.location.href = 'index.php';
            </script>
            ";
    }
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-user fa-fw"></i>Edit Password User</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
					...
					<button type="submit" class="btn btn-primary" name="user_ganti_password">Edit Password</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->
