...
$matakuliah = query("SELECT * FROM matakuliah WHERE Kode_MK = '$Kode_MK'")[0];
...
if( isset($_POST["edit_matakuliah"]) ) {
    ...
    if( editMatakuliah($_POST) > 0) {
        echo "
            <script>
                alert('Data matakuliah berhasil diedit');
        ...
        echo "
            <script>
                alert('Data matakuliah gagal diedit');
                document.location.href = 'matakuliah.php';
            </script>
            ";
    }
        ...
        <div id="wrapper">
               ...
               <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="matakuliah.php" class="active"><i class="fa fa-list-alt fa-fw"></i> Data Mata Kuliah</a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-list-alt  fa-fw"></i> Edit Data Matakuliah</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Kode Matakuliah" name="Kode_MK" id="Kode_MK" value="<?php echo $matakuliah["Kode_MK"] ?>" autocomplete="off"  readonly>
                    </div>
                    <div class="form-group">
                        <label for="Nama_MK">Nama</label>
                        <input class="form-control" placeholder="Nama Matakuliah" name="Nama_MK" id="Nama_MK" autocomplete="off" value="<?php echo $matakuliah["Nama_MK"] ?>" autofocus required>
                    </div>
                    <div class="form-group">
                        <label for="Sks">SKS</label>
                        <input type="number" class="form-control" placeholder="SKS" name="Sks" id="Sks" value="<?php echo $matakuliah["Sks"] ?>" autocomplete="off" required>
                    </div>
                    <button type="submit" class="btn btn-primary" name="edit_matakuliah">Edit Matakuliah</button>
                    </form>
                </div>
        </div>
        <!-- /#wrapper -->
