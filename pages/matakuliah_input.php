...
if( isset($_POST["input_matakuliah"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if( tambahMatakuliah($_POST) > 0) {
        echo "
            <script>
                alert('Data matakuliah berhasil ditambahkan');
        ...
        echo "
            <script>
                alert('Data matakuliah gagal ditambahkan');
                document.location.href = 'matakuliah.php';
            </script>
            ";
    }
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-list-alt fa-fw"></i> Input Data Matakuliah</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
						...
						<input type="number" class="form-control" placeholder="Kode Matakuliah" name="Kode_MK" id="Kode_MK" autocomplete="off" autofocus required>
					</div>
					<div class="form-group">
						<label for="Nama_MK">Nama</label>
						<input class="form-control" placeholder="Nama Matakuliah" name="Nama_MK" id="Nama_MK" autocomplete="off" required>
					</div>
                    <div class="form-group">
                        <label for="Sks">SKS</label>
                        <input type="number" class="form-control" placeholder="SKS" name="Sks" id="Sks" autocomplete="off" required>
                    </div>
					<button type="submit" class="btn btn-primary" name="input_matakuliah">Input Matakuliah</button>
                    </form>
				</div>
        </div>
        <!-- /#wrapper -->
