        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-list-alt fa-fw"></i> Data Matakuliah</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="matakuliah_input.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Input Matakuliah</button></a>
                                </div>
                                <!-- /.panel-heading -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><div align="center">Kode Mata Kuliah</div></th>
                                                    <th><div align="center">Nama Mata Kuliah</div></th>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                        <a style="text-decoration: none; color: white;" href="matakuliah_edit.php?Kode_MK=<?php echo $row["Kode_MK"]; ?>" >
                                                        <button class="btn btn-success">
                                                        <i class="fa fa-edit"></i> Edit
                                                    </button>
                                                        </a>
                                                        |
                                                        <a style="text-decoration: none; color: white;" href="matakuliah_hapus.php?Kode_MK=<?php echo $row["Kode_MK"]; ?>" onclick="return confirm('Hapus data matakuliah');" >
